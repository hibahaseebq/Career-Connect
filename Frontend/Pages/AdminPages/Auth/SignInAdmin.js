...
import {
  Avatar, Button, CssBaseline, FormControlLabel, Checkbox, IconButton, Link, Snackbar,
  TextField, Typography, Grid, Box, Container, Slide, Grow
} from '@mui/material';
            ...
            <Box component="form" onSubmit={handleSubmit} noValidate sx={{ mt: 1 }}>
              ...
              <Grid container>
                <Grid style={{ display: "flex", justifyContent: "center", width: "100%" }} item>
                  <Link href="/admin/auth/sign-up" variant="body2">
